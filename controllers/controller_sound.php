...
class Controller_Sound extends Controller_Base {

    public function __construct()
    {
        parent::__construct();
        $this->view->pathFolder = './modules/sound/views/';
	...
	public function action_add()
    {
		...
		$dwg = (new Sound)->add();//->setMessage('success', 'add');
    ...
    public function action_add_list()
	{
		...
		(new Sound)->addList($files);//->setMessage('success', 'add_list');
		$this->redirect();
	}
