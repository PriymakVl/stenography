<div id="term-filters-wrp">
    ...
    <select id="term-filter-type">
        ...
        <option value="<?=Term::TYPE_PART_WORD?>" <?if ($this->get->type == Term::PART_WORD) echo 'selected'; ?>>Слоги</option>
		<option value="<?=Term::WORD?>" <?if ($this->get->type == Term::WORD) echo 'selected'; ?>>Слова</option>
